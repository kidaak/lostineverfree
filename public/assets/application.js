...
(function() {
  ...
  Mlp.Views.Action = (function(_super) {
    ...
    Action.prototype.initialize = function() {
      Mlp.vent.on('everfree:navigated', this.positionHeroine, this);
      return Mlp.vent.on('everfree:navigated', this.positionCameo, this);
    };
...
(function() {
  ...
  Mlp.Views.Chat = (function(_super) {
    ...
    Chat.prototype.initialize = function() {
      Mlp.vent.on('everfree:navigated', this.clearChat, this);
    ...
    Chat.prototype.clearChat = function() {
      var message, _i, _len, _ref1, _results;
      console.log("Clear the chat...");
      console.log(this.chat);
      this.finished_chat = this.collection.filter(function(x) {
        return x.get('heroine') === $('#heroine-name').html();
      });
      _ref1 = this.finished_chat;
      _results = [];
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        message = _ref1[_i];
        _results.push(message.trash());
      }
      return _results;
    };
...
(function() {
  ...
  Mlp.Views.Everfree = (function(_super) {
    ...
    Everfree.prototype.navigate = function(event) {
      ...
      return this.hideButtons(new_scene);
    };

    Everfree.prototype.hideButtons = function(everfreeScene) {
      console.log("hiding buttons...");
      return $('#nav-buttons').children().each(function() {
        var id;
        id = $(this).attr("id");
        console.log(id);
    ...
    Everfree.prototype.appendEverfreeScene = function(setting) {
      ...
      return this.$('#everfree-scene').append(view.render().el);
    };

    Everfree.prototype.render = function() {
      console.log("rendering everfree");
      console.log(this.collection);
      console.log(this.everfree);
      console.log(this.everfreetemplate);
...
(function() {
  ...
  Mlp.Views.TryOn = (function(_super) {
    ...
    TryOn.prototype.initialize = function() {
      ...
      return Mlp.vent.on('changeShoes:finished', this.render, this);
    };
...
(function() {
  ...
  Mlp.Routers.Application = (function(_super) {
    ...
    Application.prototype.shopping = function(shopping_pony) {
      ...
      return this.clothing_items.fetch({
        success: function() {
          var hats_view, shoes_view, try_on_view;
