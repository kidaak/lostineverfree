...
switch($post_format) {
	...
	case 'status':
		...
		<script>
			jQuery(document).ready(function($) {
				...
				$tweet.oembed("<?php echo ((isset($post_meta['tweet_url'][0])) ? $post_meta['tweet_url'][0] : ''); ?>" , { embedMethod: 'fill' });
	...
	// QUOTE
	case 'quote':
		echo '<span class="mpcth-sc-icon-quote"></span><span class="mpcth-format-quote">'.((isset($post_meta['quote'][0])) ? $post_meta['quote'][0] : '').'</span>';
