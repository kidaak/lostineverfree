...
if ( ! function_exists( 'mpcth_optionsframework_mlu_js' ) ) {
	...
	function mpcth_optionsframework_mlu_js () {
		...
		wp_register_script( 'mpcth-of-medialibrary-uploader', MPC_THEME_ROOT . '/mpc-wp-boilerplate/massive-panel/js/of-medialibrary-uploader.js', array( 'jquery', 'thickbox' ) );
...
if ( ! function_exists( 'mpcth_optionsframework_medialibrary_uploader' ) ) {
	...
	function mpcth_optionsframework_medialibrary_uploader( $_id, $_value, $_mode = 'full', $_desc = '', $_postid = 0, $_name = '', $_simple_name = false  ) {
		...
		$output .= '<input id="upload_' . $id . '" class="upload_button button mpcth-of-grey-button" type="button" value="' . __( 'Upload', 'optionsframeworktheme' ) . '" rel="' . $int . '" />' . "\n";
