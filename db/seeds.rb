Setting.create!(in_everfree: true, pony_reversed: false, pony_position_left: "50%", pony_position_top: "360px", pony_width: "200px", north: 3, south: 2, east: 6, west: 5, name: "Everfree Mirror Pool", img_url:"/assets/everfree_mirror_pond.png")
